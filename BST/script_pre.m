function sFilesEpoch = script_pre(SubjectNames, RawFiles, NoiseFiles, RawEventFiles, iSubject)

% Process: Create link to raw file
sFilesRun = bst_process('CallProcess', 'process_import_data_raw', [], [], ...
    'subjectname',    SubjectNames{iSubject}, ...
    'datafile',       {RawFiles{iSubject}, 'FIF'}, ...
    'channelreplace', 1, ...
    'channelalign',   1, ...
    'evtmode',        'value');
...
sFilesNoise = bst_process('CallProcess', 'process_import_data_raw', [], [], ...
    'subjectname',    SubjectNames{iSubject}, ...
    'datafile',       {NoiseFiles{iSubject}, 'FIF'}, ...
    'channelreplace', 1, ...
    'channelalign',   1, ...
    'evtmode',        'value');

% Process: Import from file
sFilesRun = bst_process('CallProcess', 'process_evt_import', sFilesRun, [], ...
    'evtfile', {RawEventFiles{iSubject}, 'BST'}, ...
    'evtname', 'New');
...
sFilesDelay = bst_process('CallProcess', 'process_evt_detect_ecg', sFilesDelay, [], ...
    'channelname', 'ECG062', ...
    'timewindow',  [48, 1114.999], ...
    'eventname',   'cardiac');

% Process: Detect eye blinks
sFilesDelay = bst_process('CallProcess', 'process_evt_detect_eog', sFilesDelay, [], ...
    'channelname', 'EOG061', ...
    'timewindow',  [48, 1114.999], ...
    'eventname',   'blink');

% Process: Remove simultaneous
sFilesDelay = bst_process('CallProcess', 'process_evt_remove_simult', sFilesDelay, [], ...
    'remove', 'cardiac', ...
    'target', 'blink', ...
    'dt',     0.25, ...
    'rename', 0);
...
sFilesSSP = bst_process('CallProcess', 'process_ssp_eog', sFilesSSP, [], ...
    'eventname',   'blink', ...
    'sensortypes', 'MEG', ...
    'usessp',      1, ...
    'select',      1);
